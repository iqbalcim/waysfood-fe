...
import {LocationMarker} from '../Component/MapProfile'
    ...
    <div className='container-xxl' style={{ backgroundColor: "#E5E5E5", height: "100vh" }}>
      <div className='container p-5'>
        ...
        <Form onSubmit={(e) => handleSubmit(e)}>
          ...
          <Form.Group className="mb-3 d-flex">
            <Form.Control name='location' onChange={handleChange} className='border border-success border-3 border-opacity-50' value={form.location ? form.location : latlng} style={{ width: "80%", marginRight: "5px" }} type="text" placeholder="Location" />
